...
console.log(createMenuItem('Donut', 6, 'Dessert'));
console.log(createMenuItem('Bagel', 2, 'Breakfast'));
...
function addReview(reviewArr, name, rating, feedback){
  let newReview = {
    name: name,
    rating: rating,
    feedback: feedback
...
console.log(addReview(reviews, 'Me', 5, 'Was okay.'));
